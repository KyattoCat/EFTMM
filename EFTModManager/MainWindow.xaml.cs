...
namespace EFTModManager
{
    public partial class MainWindow : Window
    {
        ...
        {
            if (ModsListView.SelectedItem is ModItem selectedItem)
            {
                ModItems.Remove(selectedItem);
            }
        }
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("请先选择游戏目录", "错误", MessageBoxButton.OK, MessageBoxImage.Error);
                return;
            }
            ...
            try
            {
                ...
                MessageBox.Show("配置已保存并应用", "成功", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
